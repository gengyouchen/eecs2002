 ...
 * c:\EECS2002\Lab2\software\Lab2_software_syslib\..\..\Lab2_SOPC.ptf
 *
 * Generated: 2011-04-07 16:14:19.977
 *
 */
...
MEMORY
{
    ...
    on_chip_memory : ORIGIN = 0x09408000, LENGTH = 30000
    SSRAM_controller : ORIGIN = 0x09200000, LENGTH = 2097152
    SDRAM_controller : ORIGIN = 0x04000020, LENGTH = 67108832
    Flash_controller : ORIGIN = 0x08800000, LENGTH = 8388608
}

    /* Define symbols for each memory base-address */
 __alt_mem_on_chip_memory = 0x09408000 ;
 __alt_mem_SSRAM_controller = 0x09200000 ;
 __alt_mem_SDRAM_controller = 0x04000000 ;
 __alt_mem_Flash_controller = 0x08800000 ;
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  SDRAM_controller =0x3a880100 /* NOP on Nios2 (big endian) */
    ...
    .on_chip_memory : AT (LOADADDR (.bss) + SIZEOF (.bss))
    {
    ...
    .SSRAM_controller : AT (LOADADDR (.on_chip_memory) + SIZEOF (.on_chip_memory))
    {
    ...
    .SDRAM_controller LOADADDR (.SSRAM_controller) + SIZEOF (.SSRAM_controller): AT (LOADADDR (.SSRAM_controller) + SIZEOF (.SSRAM_controller))
    {
    ...
    .Flash_controller : AT (LOADADDR (.SDRAM_controller) + SIZEOF (.SDRAM_controller))
    {
