...
#
# Generated: 2011-05-10 01:21:19.7
...
QUARTUS_PROJECT_DIR = C:/EECS2002/Lab3

# the simulation directory is a subdirectory of the PTF directory
SIMDIR = $(QUARTUS_PROJECT_DIR)/Lab3_SOPC_sim
...
# macros defined by/for Altera Zip Read-Only File System
FLASH_PROGRAMMER_SOF = C:/altera/10.1/ip/altera/pci_compiler/lib/sopc_builder/altera_avalon_pci_compiler_adapter/
ROZIPFS_DEVICE_BASE_IN_FLASH_PROGRAMMER_SYSTEM =
...
dummy_verifysysid_file:
	nios2-download $(JTAG_CABLE)                                --sidp=0x094110c8 --id=0 --timestamp=1304960949
